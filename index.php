...
<body id="custom-background-login">

  <?php
  // Periksa jika ada pesan error dari parameter GET
  if (isset($_GET['pesan']) && $_GET['pesan']==='belum-login') {
    echo '
  ...
  }else if (isset($_GET['pesan']) && $_GET['pesan']==='sukses-logout'){
    echo'
  ...
  }else if (isset($_GET['pesan']) && $_GET['pesan']==='gagal-login'){
    echo'
    <div class="alert alert-danger alert-dismissible fade show floating-alert" role="alert">
      <i class="bi bi-exclamation-octagon me-1"></i>
                  ...
                  <form class="row g-3 needs-validation" novalidate action="prosesLogin.php" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="yourUsername" class="form-control" id="yourUsername" value="<?php echo $email; ?>" required>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="showPassword" value="true" id="showPassword" onclick="togglePassword()">
                        <label class="form-check-label" for="showPassword">Tampilkan Password</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Login <i class="bi bi-box-arrow-in-right"></i></button>
                    </div>
                  </form>
